...
--// AFILIADO
	...
	SELECT DISTINCT Paciente_Dni,
					...
					Paciente_Fecha_Nac, 
					Plan_Med_Codigo,
					AFI_USERNAME=Paciente_Nombre+Paciente_Apellido
...
--// PROFESIONAL
	...
	SELECT DISTINCT Medico_Dni,
					...
					Medico_Mail,
					Medico_Fecha_Nac,
					PRO_USERNAME=Medico_Nombre+Medico_Apellido
	FROM gd_esquema.Maestra
...
--// USUARIO
	...
	INSERT INTO [VARIETE_GDD].[USUARIO] (USU_USERNAME, USU_CLAVE) 
	SELECT AFI_NOMBRES+AFI_APELLIDO, 
			AFI_NOMBRES
					 
	FROM  VARIETE_GDD.AFILIADO
	WHERE AFI_NUMERO IS NOT NULL
	UNION
	SELECT PRO_NOMBRES+PRO_APELLIDO,
		   PRO_NOMBRES
