...
ALTER TABLE VARIETE_GDD.AFILIADO ADD FOREIGN KEY (ROLFUN_ROL) REFERENCES ROL(ROL_NOMBRE);
...
ALTER TABLE VARIETE_GDD.RECETA_MEDICAMENTOS ADD FOREIGN KEY (REC_MEDICAMENTOS) REFERENCES MEDICAMENTOS(MED_CODIGO);
