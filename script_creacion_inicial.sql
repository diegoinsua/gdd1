...
--// USUARIO
	...
	INSERT INTO [VARIETE_GDD].[USUARIO] (USU_USERNAME, USU_CLAVE) 
	SELECT left(AFI_NOMBRES+AFI_APELLIDO,25), 
			AFI_NOMBRES
					 
	FROM  VARIETE_GDD.AFILIADO
	WHERE AFI_NUMERO IS NOT NULL
	UNION
	SELECT left(PRO_NOMBRES+PRO_APELLIDO,25),
		   PRO_NOMBRES
...
--// ROL_USUARIO, PROFESIONAL Y AFILIADO
	...
	INSERT INTO [VARIETE_GDD].[ROL_USUARIO] (ROLUSU_USUARIO,ROLUSU_ROL) 
	SELECT DISTINCT PRO_CODIGO,'PROFESIONAL' FROM VARIETE_GDD.PROFESIONAL
	UNION 
	SELECT DISTINCT AFI_NUMERO,'AFILIADO' FROM VARIETE_GDD.AFILIADO
...
--// AGENDA
	...
	GROUP BY PRO_CODIGO, DATEPART(DAYOFYEAR,M.Turno_fecha)
