...
-- DROP FK
IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = object_id('VARIETE_GDD.Fk_Elemento_Form ') AND OBJECTPROPERTY(id, 'IsForeignKey') = 1)
ALTER TABLE VARIETE_GDD.ELEMENTO DROP CONSTRAINT Fk_Elemento_Form ;

IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = object_id('VARIETE_GDD.Fk_Afiliado_Afiliado ') AND OBJECTPROPERTY(id, 'IsForeignKey') = 1)
ALTER TABLE VARIETE_GDD.AFILIADO DROP CONSTRAINT Fk_Afiliado_Afiliado ;

IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = object_id('VARIETE_GDD.Fk_Afiliado_Plan ') AND OBJECTPROPERTY(id, 'IsForeignKey') = 1)
ALTER TABLE VARIETE_GDD.AFILIADO DROP CONSTRAINT Fk_Afiliado_Plan ;


IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = object_id('VARIETE_GDD.Fk_Afi_Username ') AND OBJECTPROPERTY(id, 'IsForeignKey') = 1)
ALTER TABLE VARIETE_GDD.AFILIADO DROP CONSTRAINT Fk_Afi_Username ;

IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = object_id('VARIETE_GDD.Fk_Pro_Username') AND OBJECTPROPERTY(id, 'IsForeignKey') = 1)
ALTER TABLE VARIETE_GDD.PROFESIONAL DROP CONSTRAINT Fk_Pro_Username;


IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = object_id('VARIETE_GDD.Fk_Pro_Esp_Especialidad ') AND OBJECTPROPERTY(id, 'IsForeignKey') = 1)
ALTER TABLE VARIETE_GDD.PROFESIONAL_ESPECIALIDADES DROP CONSTRAINT Fk_Pro_Esp_Especialidad ;

IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = object_id('VARIETE_GDD.Fk_Rol_Usuario_Usu ') AND OBJECTPROPERTY(id, 'IsForeignKey') = 1)
ALTER TABLE VARIETE_GDD.ROL_USUARIO DROP CONSTRAINT Fk_Rol_Usuario_Usu ;

IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = object_id('VARIETE_GDD.Fk_Rol_Usuario_Rol ') AND OBJECTPROPERTY(id, 'IsForeignKey') = 1)
ALTER TABLE VARIETE_GDD.ROL_USUARIO DROP CONSTRAINT Fk_Rol_Usuario_Rol ;

IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = object_id('VARIETE_GDD.Fk_Rol_Funcionalidades_Rol ') AND OBJECTPROPERTY(id, 'IsForeignKey') = 1)
ALTER TABLE VARIETE_GDD.ROL_FUNCIONALIDADES DROP CONSTRAINT Fk_Rol_Funcionalidades_Rol ;

IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = object_id('VARIETE_GDD.Fk_Rol_Funcionalidades_Fun ') AND OBJECTPROPERTY(id, 'IsForeignKey') = 1)
ALTER TABLE VARIETE_GDD.ROL_FUNCIONALIDADES DROP CONSTRAINT Fk_Rol_Funcionalidades_Fun ;

IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = object_id('VARIETE_GDD.Fk_Turnos_Pro ') AND OBJECTPROPERTY(id, 'IsForeignKey') = 1)
ALTER TABLE VARIETE_GDD.TURNOS DROP CONSTRAINT Fk_Turnos_Pro ;

IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = object_id('VARIETE_GDD.Fk_Turnos_Afi ') AND OBJECTPROPERTY(id, 'IsForeignKey') = 1)
ALTER TABLE VARIETE_GDD.TURNOS DROP CONSTRAINT Fk_Turnos_Afi ;

IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = object_id('VARIETE_GDD.Fk_Bono_Consulta_Afi ') AND OBJECTPROPERTY(id, 'IsForeignKey') = 1)
ALTER TABLE VARIETE_GDD.BONO_CONSULTA DROP CONSTRAINT Fk_Bono_Consulta_Afi ;

IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = object_id('VARIETE_GDD.Fk_Bono_Consulta_Consulta ') AND OBJECTPROPERTY(id, 'IsForeignKey') = 1)
ALTER TABLE VARIETE_GDD.BONO_CONSULTA DROP CONSTRAINT Fk_Bono_Consulta_Consulta ;

IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = object_id('VARIETE_GDD.Fk_Bono_Consulta_Plan ') AND OBJECTPROPERTY(id, 'IsForeignKey') = 1)
ALTER TABLE VARIETE_GDD.BONO_CONSULTA DROP CONSTRAINT Fk_Bono_Consulta_Plan ;

IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = object_id('VARIETE_GDD.Fk_Bono_Consulta_Compra ') AND OBJECTPROPERTY(id, 'IsForeignKey') = 1)
ALTER TABLE VARIETE_GDD.BONO_CONSULTA DROP CONSTRAINT Fk_Bono_Consulta_Compra ;

IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = object_id('VARIETE_GDD.Fk_Consulta_Pro ') AND OBJECTPROPERTY(id, 'IsForeignKey') = 1)
ALTER TABLE VARIETE_GDD.CONSULTA DROP CONSTRAINT Fk_Consulta_Pro ;

IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = object_id('VARIETE_GDD.Fk_Consulta_Afi ') AND OBJECTPROPERTY(id, 'IsForeignKey') = 1)
ALTER TABLE VARIETE_GDD.CONSULTA DROP CONSTRAINT Fk_Consulta_Afi ;

IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = object_id('VARIETE_GDD.Fk_Consulta_Turno ') AND OBJECTPROPERTY(id, 'IsForeignKey') = 1)
ALTER TABLE VARIETE_GDD.CONSULTA DROP CONSTRAINT Fk_Consulta_Turno ;

IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = object_id('VARIETE_GDD.Fk_Bono_Consulta_Consulta') AND OBJECTPROPERTY(id, 'IsForeignKey') = 1)
ALTER TABLE VARIETE_GDD.CONSULTA DROP CONSTRAINT Fk_Bono_Consulta_Consulta;

IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = object_id('VARIETE_GDD.Fk_Bono_Farmacia_Afi') AND OBJECTPROPERTY(id, 'IsForeignKey') = 1)
ALTER TABLE VARIETE_GDD.BONO_FARMACIA DROP CONSTRAINT Fk_Bono_Farmacia_Afi;

IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = object_id('VARIETE_GDD.Fk_Bono_Farmacia_Plan') AND OBJECTPROPERTY(id, 'IsForeignKey') = 1)
ALTER TABLE VARIETE_GDD.BONO_FARMACIA DROP CONSTRAINT Fk_Bono_Farmacia_Plan;

IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = object_id('VARIETE_GDD.Fk_Bono_Farmacia_Compra') AND OBJECTPROPERTY(id, 'IsForeignKey') = 1)
ALTER TABLE VARIETE_GDD.BONO_FARMACIA DROP CONSTRAINT Fk_Bono_Farmacia_Compra;

IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = object_id('VARIETE_GDD.Fk_Receta_Bono_Far') AND OBJECTPROPERTY(id, 'IsForeignKey') = 1)
ALTER TABLE VARIETE_GDD.RECETA DROP CONSTRAINT Fk_Receta_Bono_Far;

IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = object_id('VARIETE_GDD.Fk_Pro_Esp_Profesional') AND OBJECTPROPERTY(id, 'IsForeignKey') = 1)
ALTER TABLE VARIETE_GDD.PROFESIONAL_ESPECIALIDADES DROP CONSTRAINT Fk_Pro_Esp_Profesional;

IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = object_id('VARIETE_GDD.Fk_Rec_Med_Receta') AND OBJECTPROPERTY(id, 'IsForeignKey') = 1)
ALTER TABLE VARIETE_GDD.RECETA_MEDICAMENTOS DROP CONSTRAINT Fk_Rec_Med_Receta;

IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = object_id('VARIETE_GDD.Fk_Rec_Med_Medicamento') AND OBJECTPROPERTY(id, 'IsForeignKey') = 1)
ALTER TABLE VARIETE_GDD.RECETA_MEDICAMENTOS DROP CONSTRAINT Fk_Rec_Med_Medicamento;

IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = object_id('VARIETE_GDD.Fk_Compra_Afiliado') AND OBJECTPROPERTY(id, 'IsForeignKey') = 1)
ALTER TABLE VARIETE_GDD.COMPRA DROP CONSTRAINT Fk_Compra_Afiliado;

IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = object_id('VARIETE_GDD.Fk_Agenda_Profesional') AND OBJECTPROPERTY(id, 'IsForeignKey') = 1)
ALTER TABLE VARIETE_GDD.AGENDA DROP CONSTRAINT Fk_Agenda_Profesional;

IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = object_id('VARIETE_GDD.Fk_Planes_Modif_PlanNew') AND OBJECTPROPERTY(id, 'IsForeignKey') = 1)
ALTER TABLE VARIETE_GDD.PLANES_MODIFICADOS DROP CONSTRAINT Fk_Planes_Modif_PlanNew;

IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = object_id('VARIETE_GDD.Fk_Planes_Modif_PlanOld') AND OBJECTPROPERTY(id, 'IsForeignKey') = 1)
ALTER TABLE VARIETE_GDD.PLANES_MODIFICADOS DROP CONSTRAINT Fk_Planes_Modif_PlanOld;

IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = object_id('VARIETE_GDD.Fk_Planes_Modif_Afi') AND OBJECTPROPERTY(id, 'IsForeignKey') = 1)
ALTER TABLE VARIETE_GDD.PLANES_MODIFICADOS DROP CONSTRAINT Fk_Planes_Modif_Afi;

IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = object_id('VARIETE_GDD.Fk_Cancelacion_Turno_TurCodigo') AND OBJECTPROPERTY(id, 'IsForeignKey') = 1)
ALTER TABLE VARIETE_GDD.CANCELACION_TURNO DROP CONSTRAINT Fk_Cancelacion_Turno_TurCodigo;


-- DROP TABLAS
IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = object_id('VARIETE_GDD.FORMULARIO') AND  OBJECTPROPERTY(id, 'IsUserTable') = 1)
DROP TABLE VARIETE_GDD.FORMULARIO;

IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = object_id('VARIETE_GDD.ELEMENTO') AND  OBJECTPROPERTY(id, 'IsUserTable') = 1)
DROP TABLE VARIETE_GDD.ELEMENTO;
...
-- CREACION DE TABLAS
CREATE TABLE VARIETE_GDD.FORMULARIO  (
            FOR_NOMBRE VARCHAR(30) NOT NULL, 
            FOR_RUTA VARCHAR(255) 
)

CREATE TABLE VARIETE_GDD.ELEMENTO( 
           ELE_NOMBRE VARCHAR(30) NOT NULL, 
           ELE_PADRE VARCHAR(30) NOT NULL, 
           ELE_FUNCIONALIDAD VARCHAR(30) NOT NULL, 
           ELE_FORM VARCHAR(30)
)
...
CREATE TABLE VARIETE_GDD.AFILIADO ( 
	...
	AFI_TIPO_DOCUMENTO VARCHAR(3) DEFAULT 'DNI',
	...
	AFI_USERNAME VARCHAR(255) NOT NULL
)
...
CREATE TABLE VARIETE_GDD.PROFESIONAL ( 
	...
	PRO_TIPO_DOCUMENTO VARCHAR(3) DEFAULT 'DNI',
...
CREATE TABLE VARIETE_GDD.ROL_USUARIO (
	...
	ROLUSU_ROL VARCHAR (30) NOT NULL
)


CREATE TABLE VARIETE_GDD.ROL (
	ROL_NOMBRE VARCHAR (30) NOT NULL, --AFILIADO O PROFESIONAL O ADMINISTRADOR
	ROL_HABILITADO BIT NOT NULL
)

CREATE TABLE VARIETE_GDD.ROL_FUNCIONALIDADES (
	ROLFUN_ROL VARCHAR (30) NOT NULL,
	ROLFUN_FUNCIONALIDAD VARCHAR(30) NOT NULL
)	


CREATE TABLE VARIETE_GDD.FUNCIONALIDADES (
	FUN_FUNCIONALIDAD VARCHAR(30) NOT NULL
)
...
CREATE TABLE VARIETE_GDD.COMPRA (
	...
	COM_BONO_CONSULTA INTEGER DEFAULT '0',
	COM_BONO_FARMACIA INTEGER DEFAULT '0'
)	
...
CREATE TABLE VARIETE_GDD.PLANES_MODIFICADOS(
	...
	PLAMOD_AFILIADO INTEGER NOT NULL
)
...
--//FORMULARIO
ALTER TABLE VARIETE_GDD.FORMULARIO ADD CONSTRAINT Pk_Formulario PRIMARY KEY (FOR_NOMBRE);

--//ELEMENTO
ALTER TABLE VARIETE_GDD.ELEMENTO ADD CONSTRAINT Pk_Elemento PRIMARY KEY (ELE_NOMBRE,ELE_PADRE,ELE_FUNCIONALIDAD);
ALTER TABLE VARIETE_GDD.ELEMENTO ADD CONSTRAINT Fk_Elemento_Form FOREIGN KEY (ELE_FORM) REFERENCES VARIETE_GDD.FORMULARIO(FOR_NOMBRE);

--//USUARIO
ALTER TABLE VARIETE_GDD.USUARIO ADD CONSTRAINT Pk_Usuario PRIMARY KEY (USU_USERNAME);
...
--//FUNCIONALIDADES
ALTER TABLE VARIETE_GDD.FUNCIONALIDADES ADD CONSTRAINT Pk_Funcionalidades PRIMARY KEY (FUN_FUNCIONALIDAD);
ALTER TABLE VARIETE_GDD.PROFESIONAL ADD CONSTRAINT Pk_Profesional PRIMARY KEY (PRO_CODIGO);
...
ALTER TABLE VARIETE_GDD.ROL_FUNCIONALIDADES ADD CONSTRAINT Fk_Rol_Funcionalidades_Fun FOREIGN KEY (ROLFUN_FUNCIONALIDAD) REFERENCES VARIETE_GDD.FUNCIONALIDADES(FUN_FUNCIONALIDAD);

--//ROL_USUARIO
ALTER TABLE VARIETE_GDD.ROL_USUARIO ADD CONSTRAINT Pk_Rol_Usuario PRIMARY KEY (ROLUSU_USUARIO,ROLUSU_ROL);
ALTER TABLE VARIETE_GDD.ROL_USUARIO ADD CONSTRAINT Fk_Rol_Usuario_Usu FOREIGN KEY (ROLUSU_USUARIO) REFERENCES VARIETE_GDD.USUARIO(USU_USERNAME);
...
ALTER TABLE VARIETE_GDD.PROFESIONAL_ESPECIALIDADES ADD CONSTRAINT Fk_Pro_Esp_Profesional FOREIGN KEY (PROESP_PROFESIONAL) REFERENCES VARIETE_GDD.PROFESIONAL(PRO_CODIGO);
ALTER TABLE VARIETE_GDD.PROFESIONAL_ESPECIALIDADES ADD CONSTRAINT Fk_Pro_Esp_Profesional  FOREIGN KEY (PROESP_PROFESIONAL) REFERENCES VARIETE_GDD.PROFESIONAL(PRO_CODIGO);


--//PROFESIONAL	
ALTER TABLE VARIETE_GDD.PROFESIONAL ADD CONSTRAINT Pk_Profesional PRIMARY KEY (PRO_CODIGO);
ALTER TABLE VARIETE_GDD.PROFESIONAL ADD CONSTRAINT Fk_Pro_Username FOREIGN KEY (PRO_USERNAME) REFERENCES VARIETE_GDD.USUARIO(USU_USERNAME);
...
--//AFILIADO
ALTER TABLE VARIETE_GDD.AFILIADO ADD CONSTRAINT Pk_Afiliado PRIMARY KEY (AFI_NUMERO);
...
ALTER TABLE VARIETE_GDD.AFILIADO ADD CONSTRAINT Fk_Afiliado_Username FOREIGN KEY (AFI_USERNAME) REFERENCES VARIETE_GDD.USUARIO(USU_USERNAME);


--//COMPRA
ALTER TABLE VARIETE_GDD.COMPRA ADD CONSTRAINT Pk_Compra PRIMARY KEY (COM_CODIGO);
ALTER TABLE VARIETE_GDD.COMPRA ADD CONSTRAINT Fk_Compra_Afiliado FOREIGN KEY (COM_AFILIADO) REFERENCES VARIETE_GDD.AFILIADO(AFI_NUMERO);

--//TURNOS
ALTER TABLE VARIETE_GDD.TURNOS ADD CONSTRAINT Pk_Turnos PRIMARY KEY (TUR_CODIGO);
ALTER TABLE VARIETE_GDD.TURNOS ADD CONSTRAINT Fk_Turnos_Pro FOREIGN KEY (TUR_PROFESIONAL) REFERENCES VARIETE_GDD.PROFESIONAL(PRO_CODIGO);
ALTER TABLE VARIETE_GDD.TURNOS ADD CONSTRAINT Fk_Turnos_Afi FOREIGN KEY (TUR_AFILIADO) REFERENCES VARIETE_GDD.AFILIADO(AFI_NUMERO);

--//CONSULTA
ALTER TABLE VARIETE_GDD.CONSULTA ADD CONSTRAINT Pk_Consulta PRIMARY KEY (CON_CODIGO);
ALTER TABLE VARIETE_GDD.CONSULTA ADD CONSTRAINT Fk_Consulta_Pro FOREIGN KEY (CON_PROFESIONAL) REFERENCES VARIETE_GDD.PROFESIONAL(PRO_CODIGO);
ALTER TABLE VARIETE_GDD.CONSULTA ADD CONSTRAINT Fk_Consulta_Afi FOREIGN KEY (CON_AFILIADO) REFERENCES VARIETE_GDD.AFILIADO(AFI_NUMERO);
...
ALTER TABLE VARIETE_GDD.BONO_FARMACIA ADD CONSTRAINT Fk_Bono_Farmacia_Afi FOREIGN KEY (BONFAR_AFILIADO) REFERENCES VARIETE_GDD.AFILIADO(AFI_NUMERO);
...
ALTER TABLE VARIETE_GDD.BONO_CONSULTA ADD CONSTRAINT Fk_Bono_Consulta_Afi FOREIGN KEY (BONCON_AFILIADO) REFERENCES VARIETE_GDD.AFILIADO(AFI_NUMERO);
...
ALTER TABLE VARIETE_GDD.AGENDA ADD CONSTRAINT Fk_Agenda_Profesional FOREIGN KEY (AGE_PROFESIONAL) REFERENCES VARIETE_GDD.PROFESIONAL(PRO_CODIGO);
...
ALTER TABLE VARIETE_GDD.PLANES_MODIFICADOS ADD CONSTRAINT Fk_Planes_Modif_Afi FOREIGN KEY (PLAMOD_AFILIADO) REFERENCES VARIETE_GDD.AFILIADO(AFI_NUMERO);
...
--// USUARIO, ADMINISTRADOR	
	...
	INSERT INTO [VARIETE_GDD].[USUARIO] (USU_USERNAME,USU_CLAVE) 
	VALUES 	('admin','w23e')
...
--	SET IDENTITY_INSERT VARIETE_GDD.FUNCIONALIDADES ON
	...
	INSERT INTO [VARIETE_GDD].[FUNCIONALIDADES] (FUN_FUNCIONALIDAD) 
	VALUES 	('Abm de Rol'), 
			('Registro de Usuario'), 
			('Abm Afiliado'), 
			('Abm Profesional'), 
...
--// ROL_FUNCIONALIDADES
	...
	VALUES 	('ADMINISTRADOR','Abm de Rol'), 
			...
			('ADMINISTRADOR','Registrar Agenda Profesional'), 
			('ADMINISTRADOR','Compra de bonos'), 
			('ADMINISTRADOR','Pedido de turno'),
			('ADMINISTRADOR','Registro de llegada'),
			('ADMINISTRADOR','Registro de resultado'), 
			('ADMINISTRADOR','Cancelar atención médica'), 
			('ADMINISTRADOR','Generar Receta'), 
			('ADMINISTRADOR','Listado estadístico'), 
			('AFILIADO','Compra de bonos'), 
			('AFILIADO','Pedido de turno'), 
			('AFILIADO','Cancelar atención médica'), 
			('AFILIADO','Abm Afiliado'),
			('PROFESIONAL','Registro de llegada'), 
...
--// AFILIADO
	...
	INSERT INTO [VARIETE_GDD].[AFILIADO] (AFI_DNI, AFI_NOMBRES, AFI_APELLIDO,AFI_DIRECCION,AFI_TELEFONO,AFI_MAIL,AFI_FECHA_NACIMIENTO,AFI_PLAN_MEDICO,AFI_USERNAME) 
	SELECT DISTINCT Paciente_Dni,
					...
					Paciente_Fecha_Nac, 
					Plan_Med_Codigo,
					AFI_USERNAME=left(Paciente_Nombre+Paciente_Apellido,25)
	FROM gd_esquema.Maestra
	WHERE Paciente_Dni IS NOT NULL
	
--// PROFESIONAL

	INSERT INTO [VARIETE_GDD].[PROFESIONAL] (PRO_DNI,PRO_NOMBRES,PRO_APELLIDO,PRO_DIRECCION,PRO_TELEFONO,PRO_MAIL,PRO_FECHA_NACIMIENTO,PRO_USERNAME) 
	SELECT DISTINCT Medico_Dni,
					...
					Medico_Mail,
					Medico_Fecha_Nac,
					PRO_USERNAME=left(Medico_Nombre+Medico_Apellido,25)
	FROM gd_esquema.Maestra
	WHERE Medico_Dni IS NOT NULL


--// USUARIO
	--USERNAME: AFI_NUMERO --PASS: AFI_NOMBRES
	INSERT INTO [VARIETE_GDD].[USUARIO] (USU_USERNAME, USU_CLAVE) 
	SELECT AFI_USERNAME, 
			AFI_NOMBRES
					 
	FROM  VARIETE_GDD.AFILIADO
	WHERE AFI_NUMERO IS NOT NULL
	UNION
	SELECT PRO_USERNAME,
		   PRO_NOMBRES
	FROM VARIETE_GDD.PROFESIONAL	
...
--// ROL_USUARIO, PROFESIONAL Y AFILIADO
	...
	INSERT INTO [VARIETE_GDD].[ROL_USUARIO] (ROLUSU_USUARIO,ROLUSU_ROL) 
	SELECT DISTINCT PRO_USERNAME,'PROFESIONAL' FROM VARIETE_GDD.PROFESIONAL
	UNION 
	SELECT DISTINCT AFI_USERNAME,'AFILIADO' FROM VARIETE_GDD.AFILIADO
...
--// TURNOS
	...
	SELECT DISTINCT M.Turno_Numero,PRO_CODIGO,AFI_NUMERO,M.Turno_Fecha
...
--// COMPRAS
	...
	INSERT INTO [VARIETE_GDD].[COMPRA] (COM_FECHA,COM_CANTIDAD_BONO_FARMACIA,COM_CANTIDAD_BONO_CONSULTA,COM_PRECIO,COM_AFILIADO,COM_BONO_CONSULTA,COM_BONO_FARMACIA) 
...
--CREATE PROCEDURE LASCOGON.Migrar_Compra_de_Bonos_Farmacia
--AS
--BEGIN
--    INSERT INTO LASCOGON.Bono_Farmacia (ID,
--                                          ID_Compra,
--                                          fecha_impresion,
--                                          fecha_vencimiento)
--    SELECT 
...
--    DATEADD(day, 60, cb.Fecha_Compra)
--	FROM LASCOGON.Compra_Bono cb
--    JOIN gd_esquema.Maestra m on (cb.DNI_Afiliado = m.Paciente_Dni and cb.Fecha_Compra = m.Compra_Bono_Fecha)
...
--END
	...
	SELECT DISTINCT M.Bono_Consulta_Numero,
					...
					A.AFI_PLAN_MEDICO,
					C.COM_CODIGO 
	FROM gd_esquema.Maestra M JOIN VARIETE_GDD.COMPRA C ON C.COM_FECHA=M.Bono_Consulta_Fecha_Impresion and COM_BONO_CONSULTA=M.Bono_Consulta_Numero
						      JOIN VARIETE_GDD.AFILIADO A ON M.Paciente_Dni=A.AFI_DNI AND A.AFI_NUMERO=C.COM_AFILIADO
	
	WHERE M.Bono_Consulta_Numero IS NOT NULL AND M.Compra_Bono_Fecha IS NOT NULL AND COM_CODIGO IS NOT NULL



--	FROM VARIETE_GDD.COMPRA C, gd_esquema.Maestra M, VARIETE_GDD.AFILIADO A
--	WHERE COM_AFILIADO=A.AFI_NUMERO AND M.Paciente_Dni=A.AFI_DNI AND COM_FECHA=M.Compra_Bono_Fecha AND M.Bono_Consulta_Numero IS NOT NULL AND M.Compra_Bono_Fecha IS NOT NULL
	
	
	
	--JOIN gd_esquema.Maestra M ON COM_AFILIADO=M.Paciente_Dni AND COM_FECHA=M.Compra_Bono_Fecha
	--					    JOIN VARIETE_GDD.AFILIADO ON M.Paciente_Dni=AFI_DNI AND AFI_DNI=COM_AFILIADO
						  
	--WHERE M.Bono_Consulta_Numero IS NOT NULL AND M.Compra_Bono_Fecha IS NOT NULL AND COM_CODIGO IS NOT NULL
	
	-- 	INSERT INTO [VARIETE_GDD].BONO_CONSULTA(BONCON_CODIGO ,BONCON_AFILIADO ,BONCON_CONSULTA,BONCON_FECHA ,BONCON_PLAN)
	--SELECT DISTINCT M.Bono_Consulta_Numero,
	--				AFI_NUMERO,
	--				M.Bono_Consulta_Numero,
	--				M.Bono_Consulta_Fecha_Impresion, 
	--				AFI_PLAN_MEDICO
	--FROM gd_esquema.Maestra M JOIN VARIETE_GDD.AFILIADO ON M.Paciente_Dni=AFI_DNI AND Paciente_Apellido=AFI_APELLIDO AND Paciente_Nombre=AFI_NOMBRES
	--WHERE M.Bono_Consulta_Numero IS NOT NULL AND M.Compra_Bono_Fecha IS NOT NULL
	 

--from gd_esquema.Maestra	ma
--JOIN THE_SHIRE.Afiliados af on ma.Paciente_Apellido = af.apellido and ma.Paciente_Nombre = af.nombre and ma.Paciente_Dni = af.nro_doc
--join THE_SHIRE.Compras co on co.nro_grupo = af.nro_grupo and co.nro_afiliado = af.nro_afiliado
--							 and co.fecha_compra = Bono_Consulta_Fecha_Impresion and co.nro_bono_consulta = Bono_Consulta_Numero
...
--SET IDENTITY_INSERT THE_SHIRE.BONO_FARMACIA ON
	...
	SELECT DISTINCT M.Bono_Farmacia_Numero,
					...
					A.AFI_PLAN_MEDICO,
					C.COM_CODIGO
	FROM gd_esquema.Maestra M JOIN VARIETE_GDD.COMPRA C ON C.COM_FECHA=M.Bono_Farmacia_Fecha_Impresion and C.COM_BONO_FARMACIA=M.Bono_Farmacia_Numero
						      JOIN VARIETE_GDD.AFILIADO A ON M.Paciente_Dni=A.AFI_DNI AND A.AFI_NUMERO=C.COM_AFILIADO
	WHERE M.Bono_Farmacia_Numero IS NOT NULL AND M.Compra_Bono_Fecha IS NOT NULL AND COM_CODIGO IS NOT NULL

	
	
	--FROM VARIETE_GDD.COMPRA C, gd_esquema.Maestra M, VARIETE_GDD.AFILIADO A
	--WHERE COM_AFILIADO=A.AFI_NUMERO 
	--	  AND M.Paciente_Dni=A.AFI_DNI
	--	  AND M.Paciente_Apellido=A.AFI_APELLIDO
	--	  AND M.Paciente_Nombre=A.AFI_NOMBRES  
	--	  AND C.COM_FECHA=M.Compra_Bono_Fecha 
	--	  AND M.Bono_Farmacia_Numero IS NOT NULL 
	--	  AND M.Compra_Bono_Fecha IS NOT NULL

	
	
	--JOIN VARIETE_GDD.AFILIADO ON M.Paciente_Dni=AFI_DNI 
	--						  JOIN VARIETE_GDD.COMPRA ON COM_AFILIADO=M.Paciente_Dni AND COM_FECHA=M.Compra_Bono_Fecha
	--WHERE M.Bono_Farmacia_Numero IS NOT NULL AND M.Compra_Bono_Fecha IS NOT NULL 
	
--SET IDENTITY_INSERT THE_SHIRE.BONO_FARMACIA OFF
