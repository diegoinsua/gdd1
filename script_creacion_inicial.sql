...
IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = object_id('VARIETE_GDD.Fk_Pro_Profesional ') AND OBJECTPROPERTY(id, 'IsForeignKey') = 1)
ALTER TABLE VARIETE_GDD.PROFESIONAL DROP CONSTRAINT Fk_Pro_Profesional ;
